// To parse this data:
//
//   import { Convert, SearchPopularMovie } from "./file";
//
//   const searchPopularMovie = Convert.toSearchPopularMovie(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchPopularMovie {
	page:          number;
	results:       Result[];
	total_pages:   number;
...
export class Convert {
	public static toSearchPopularMovie(json: string): SearchPopularMovie {
			return cast(JSON.parse(json), r("SearchPopularMovie"));
	}

	public static searchPopularMovieToJson(value: SearchPopularMovie): string {
			return JSON.stringify(uncast(value, r("SearchPopularMovie")), null, 2);
	}
}
